export default function ContactSection() {
  return (
    <section id="contact" className="bg-primary-600 text-white section-padding">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-primary-100">hello@professionalservices.com</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-primary-100">123 Business St, Suite 100<br />City, State 12345</p>
            </div>
          </div>
